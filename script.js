...
function getUserInput(event) {
  const newBook = new Book(); // Creates new Book object instance
  newBook.info(titleInput.value, authorInput.value, pagesInput.value);
...
Book.prototype.info = function (title, author, pages) {
  this.title = title;
  this.author = author;
  this.pages = pages;
  this.read = false;
...
Book.prototype.getDataId = function () {
  return this.dataId;
};
